<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Admin Member Management.aspx.cs" Inherits="FINAl_PROJECT.Admin_Member_Management" %>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LikhithaConnectionString %>" SelectCommand="SELECT * FROM [member_table]"></asp:SqlDataSource>
                     <div class="col">
